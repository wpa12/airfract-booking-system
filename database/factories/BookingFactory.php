...
class BookingFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'bookable_type' => fake()->randomElement(self::bookableTypes()),
            'user_id' => fake()->numberBetween(1, 10),
            'flight_school_id' => fake()->numberBetween(1, 10),
            'booking_date_time_start' => fake()->time(),
            'booking_date_time_end' => fake()->time(),
        ];
    }
}
